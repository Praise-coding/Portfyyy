...
const HeroSection = () => {
    ...
    return (
        <section ref={ref} className={"sm:mt-[114px] mt-[40px] flex justify-center px-[20px]"}>
            <div className={"max-w-[1170px] grid grid-cols-1 md:grid-cols-2  flex justify-between gap-[50px] md:gap-[87px] w-full"}>

                <AnimateCon hidden={{ opacity: 0}} visible={{ opacity: 100, transition: {duration: 0.7}}}
                            htmlElement={"div"} once={false}>
                    <div className={"grid gap-[20px] "}>
                        ...
                        <h2 className={" mt-[20px] relative sm:mt-[0px] max-w-[513px] w-full   font-[800] text-[56px] leading-[64px] sm:text-[72px] sm:leading-[80px] tracking-[-1px] sm:tracking-[-2px] text-white"}>
                            ...
                            <div
                                className={"sm:right-[40px] w-fit z-[-1] right-0 top-[-34px] opacity-[50%] absolute"}>
                                <svg
                                    width="148"
                ...
                <AnimateCon className={"flex   max-w-[570px] w-full justify-center"} hidden={{opacity: 0}}
                            visible={{opacity: 1, transition: {duration: 0.7}}} htmlElement={"div"}  once={false}>
                    <Image width={800}
