...
function ProjectsCard({keyProp, projectData, displayProject}: { keyProp: number, projectData : ProjectTypes, displayProject:  React.Dispatch<React.SetStateAction<null | ProjectTypes>> }) {
    ...
    return (
        <article
            ...
            className={`relative ${(keyProp == 0 || keyProp == 3)  ? "md:col-span-2" : "md:col-span-3"} cursor-pointer md:h-auto h-[416px] overflow-hidden rounded-[8px]`}>
